...
import NavbarLand from "./Navbar";
import Footer from "./Footer";

const BlogDetail1L = () => {
  const location = useLocation();
  const blog = location.state?.news; // Access the blog data correctly
        ...
        <div className="container mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 mt-5">
          ...
          <div className="lg:col-span-8 bg-white rounded-lg shadow-lg p-6 mb-12">
            ...
            <div className="mt-8">
              ...
              ></textarea>
              <button className="mt-4 bg-teal-500 text-white px-6 py-2 rounded">
                Post Comment
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <div className="flex justify-center">
                ...
                />
                <button className="bg-teal-500 text-white px-4 py-3 rounded-r-lg">
                  Subscribe
                </button>
              </div>
            </div>
