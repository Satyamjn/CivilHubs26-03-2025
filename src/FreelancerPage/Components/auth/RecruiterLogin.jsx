    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
        <div className="flex flex-col md:flex-row bg-white shadow-xl rounded-lg overflow-hidden max-w-4xl w-full">
          {/* Left Section */}
          <div className="p-8 md:w-1/2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white">
            <h1 className="text-4xl font-bold leading-tight">Hire top talent in 48 hours with apna.</h1>
            <p className="mt-4 text-lg">Streamline your recruitment with AI-driven precision. Single solution from fresher to experienced hiring.</p>
            <div className="mt-6">
              ...
              <p className="text-yellow-300 font-semibold text-lg">7 lakhs+ <span className="text-gray-300 font-normal">Employers use apna</span></p>
              <p className="text-yellow-300 font-semibold text-lg">900+ <span className="text-gray-300 font-normal">Available cities</span></p>
            </div>
          </div>
          {/* Right Section */}
          <div className="p-8 bg-gray-50 md:w-1/2 flex flex-col justify-center">
            <h2 className="text-3xl font-semibold text-gray-800">Let's get started</h2>
            <p className="text-lg text-gray-600 mt-2">Hire top talent faster with apna</p>
            ...
            <form onSubmit={handleLogin} className="mt-6 space-y-4">
              ...
              <button
                type="submit"
                className="mt-4 bg-green-600 text-white px-6 py-3 rounded-lg w-full transition duration-300 ease-in-out hover:bg-green-700"
              >
                Login
              </button>
            </form>
