...
const Footer = () => {
  return (
    <footer className="bg-[#161616] text-white py-12  px-7">
      <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10">
        <div>  
             <Link to={'/freelancehome'}><img src="/assets/Civilhubs/blacklogo.png" alt="CivilHubs Logo" className="w-26 mb-3 h-9" /></Link>
      ...
      <div className="border-t-2 translate-y-8   border-gray-00   flex flex-col md:flex-row justify-between text-gray-00 text-sm">
