      ...
      <div className='bg-gray-100'>
        <div className="max-h-2xl">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-white rounded-lg shadow-sm mt-10 ">
              <div className="relative">
                <img
                  src="https://png.pngtree.com/background/20211217/original/pngtree-dark-blue-plain-background-for-design-template-picture-image_1598210.jpg"
              ...
              <div className="p-6 pt-16">
                ...
                <div className="mt-48 flex place-content-center gap-[620px] ">
                  ...
                  <button className="bg-teal-500 text-white px-10 py-2 rounded-full">Hire</button>
                </div>
