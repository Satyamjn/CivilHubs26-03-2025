              ...
              <div className="p-6 pt-16">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  <div>
                    ...
                    <h2 className="text-xl font-semibold mt-1">Skills</h2>
                    <div className="mt-2 flex flex-wrap space-x-2">
                      {currentProfile.skills.map((skill, index) => (
                        <span 
                          key={index} 
                          className="px-2 py-1 bg-white text-teal-500 border border-teal-500 rounded-full text-sm cursor-pointer hover:bg-teal-500 hover:text-white transition"
                        >
                          {skill}
                        </span>
                      ))}
                ...
                {/* upload resume */}
                <div className="bg-white rounded-xl shadow-lg p-6 mt-5 border border-gray-200 ">
                  <h3 className="text-xl font-semibold text-gray-900">Resume</h3>
                  <div className="mt-4 max-w-md  flex items-center justify-between bg-gray-100 border border-gray-300 rounded-lg p-2 hover:shadow-md transition-shadow">
                    <div className="flex items-center space-x-3">
                      <div className="bg-red-100 p-2 rounded-lg">
                        <DocumentTextIcon className="w-6 h-6 text-red-500" />
                      </div>
                      <p className="text-gray-800 font-medium">My Resume.pdf</p>
                    </div>
                    <button className="bg-teal-500 hover:bg-teal-600 text-white p-2 rounded-lg shadow-md transition-all">
                ...
                <div className="mt-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                    {currentProfile.workingHistory.map((item) => (
                ...
                <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    {currentProfile.education.map((item) => (
                ...
                <div className="mt-12 mb-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    {currentProfile.employmentHistory.map((item) => (
                      <div key={item.id} className="bg-white p-4 rounded-lg shadow">
                        <div className="flex items-center">
                ...
                <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    {currentProfile.languages.map((item) => (
                      <div key={item.id} className="bg-white p-4 rounded-lg shadow">
                        <div className="flex items-center">
...
//   ];
//   const portfolioData = [
//     { id: 1, image: "src/assets/Civilhubs/project2.jpg", alt: "Project 1" },
//     { id: 2, image: "src/assets/Civilhubs/construct3.png", alt: "Project 2" },
//     { id: 3, image: "src/assets/Civilhubs/construct.png", alt: "Project 3" },
//   ];
