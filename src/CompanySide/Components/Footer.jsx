  ...
  return (
    <footer className="bg-[#161616]  text-white py-12 -mt-10 px-7">
      <div className="max-w-8xl mx-auto  grid grid-cols-1 md:grid-cols-5 gap-10">
        <div>  
             <Link to={'/companyhome'}><img src="/assets/Civilhubs/blacklogo.png" alt="CivilHubs Logo" className="w-26 h-9 mb-4" /></Link>
          <p className="text-gray-100 mb-5">{footerData.description}</p>
      ...
      <div className="border-t-2 translate-y-8      flex flex-col md:flex-row justify-between  text-sm">
