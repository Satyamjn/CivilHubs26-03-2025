...
const NavbarBusiness = () => {
    ...
    return (
        <nav className="sticky top-0 z-10 flex flex-col sm:flex-row justify-between items-center px-4 sm:px-10 py-2 bg-[#f9fafe] shadow-sm border-teal-800">
            {/* Logo Section */}
            ...
            <div className="hidden sm:flex flex-col sm:flex-row gap-4 sm:gap-9 text-gray-700 font-medium mt-2 sm:mt-0 sm:ml-auto mr-10">
                <Link to={'/businesshome'} className="hover:text-[#0177cd] ">Home</Link>
                <Link to="/productandServices" className="hover:text-[#0177cd]">Products</Link>
                <Link to="/oders" className="hover:text-[#0177cd]">Orders</Link>
                <Link to="/businessmessages" className="hover:text-[#0177cd]">Messages</Link>
            </div>
                ...
                <div className="relative hidden sm:block">
                    ...
                    {dropdownOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                            <Link to="/businessProfile" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">View Profile</Link>
            ...
            {/* Mobile Menu */}
            {mobileMenuOpen && (
                <div className="absolute top-16 left-0 right-0 bg-white border border-gray-300 rounded-md shadow-lg z-20 p-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className ="relative">
                            <button
                                onClick={toggleDropdown}
                                className="flex items-center justify-center w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100"
                            >
                                <User  className="w-6 h-6 text-gray-700 inline-block" /> Profile
                            </button>
                            {dropdownOpen && (
