...
const Blogs = () => {
  ...
  return (
    <div className="py-10 bg-auto -mt-28">
      <h2 className="text-3xl ml-12 font-bold text-start ">
          ...
          {newsData.map((news, index) => (
            ...
            >
              <div 
                ...
                onClick={() => navigate('/blogdetail1B', { state: { news } })} // Navigate to the blog detail page
              >
                <img
                  src={news.imageUrl}
                  alt={news.title}
