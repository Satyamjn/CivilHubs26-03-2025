  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row">
        {/* Filters Section */}
        <aside className="w-full lg:w-1/4 p-7 bg-white border rounded-xl border-gray-200 text-xs text-gray-700 font-normal mb-4">
          <div className="mb-4">
    ...
    onClick={() => navigate("/hireprofile", { state: { job, dummy, skill } })}
  ...
  >
    ...
    <div className="p-6 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 flex flex-col justify-center text-start">
      ...
      >
        ...
        <aside className="w-full lg:w-1/3 p-2 bg-white shadow-lg border rounded-lg mb-8 h-auto">
          <SimilarProfiles />
        </aside>
      </div>
      <Footer/>
